...
# Filter out the columns with the dates
#confirmed_cases_df <- cases_df[, -c(1:4)]
...
risk_scores_latest <- deaths_latest[,ncol(deaths_latest)] / confirmed_cases_latest[,ncol(deaths_latest)] * 100
